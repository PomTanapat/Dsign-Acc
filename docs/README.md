...
| 7 | [specs/phase-7-guidance-onboarding.md](specs/phase-7-guidance-onboarding.md) | **BUILT** (branch `feat/phase-7-guidance-onboarding`) — guidance modes, explainers, industry onboarding · [implementation plan](specs/phase-7-implementation-plan.md) · [QA checklist](specs/phase-7-qa-checklist.md) · [build prompt](specs/phase-7-build-prompt.md) |
